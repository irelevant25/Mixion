...
/// <c>%LOCALAPPDATA%\VoicemeterAlt\runtime\url.txt</c>. Subsequent launches
...
{
    private const string MutexName = @"Local\VoicemeterAlt";
    ...
    private static void ForwardToRunningInstance(bool noBrowser)
    {
        ...
        if (!string.IsNullOrEmpty(url))
        {
            ...
            Console.WriteLine();
            Console.WriteLine($"  VoicemeterAlt is already running at {url}");
            Console.WriteLine();
        ...
        else
        {
            ...
            Console.WriteLine();
            Console.WriteLine("  VoicemeterAlt is already running but its URL is unknown.");
