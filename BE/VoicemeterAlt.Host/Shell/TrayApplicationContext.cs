...
internal sealed class TrayApplicationContext : ApplicationContext
{
    ...
    private static Icon LoadTrayIcon()
    {
        try
        {
            // Prefer the icon embedded in the .exe (ApplicationIcon in the
            // .csproj). Falling back to SystemIcons.Application gives a
            // visible glyph even in unusual hosting (unit-test runner,
            // dotnet-ef, etc.) where MainModule.FileName is unexpected.
